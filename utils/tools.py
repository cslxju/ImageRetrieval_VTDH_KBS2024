...
def config_dataset(config):
    ...
    if config["dataset"] == "nuswide_21":
        config["data_path"] = "/home/xx/dataset/nus-wide/"
    if config["dataset"] in ["nuswide_21_m", "nuswide_81_m"]:
        config["data_path"] = "./dataset/nus_wide_m/"
    if config["dataset"] == "coco":
        config["data_path"] = "/home/xx/dataset/COCO_2014/"
    if config["dataset"] == "imagenet":
        config["data_path"] = "/home/xx/dataset/Imagenet/"
    config["data"] = {
        "train_set": {"list_path": "/home/xx/dataset/" + config["dataset"] + "/train.txt", "batch_size": config["batch_size"]},
        "database": {"list_path": "/home/xx/dataset/" + config["dataset"] + "/database.txt", "batch_size": config["batch_size"]},
        "test": {"list_path": "/home/xx/dataset/" + config["dataset"] + "/test.txt", "batch_size": config["batch_size"]}}
    return config
...
def cifar_dataset(config):
    ...
    cifar_dataset_root = '/home/xx/dataset/cifar10'
    # Dataset
